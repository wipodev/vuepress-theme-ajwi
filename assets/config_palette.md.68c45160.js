import{_ as s,c as n,o as a,a as l}from"./app.bc8f8ce5.js";const F=JSON.parse('{"title":"paleta de colores (Palette)","description":"","frontmatter":{},"headers":[],"relativePath":"config/palette.md","lastUpdated":1677599420000}'),p={name:"config/palette.md"},o=l(`<h1 id="paleta-de-colores-palette" tabindex="-1">paleta de colores (Palette) <a class="header-anchor" href="#paleta-de-colores-palette" aria-hidden="true">#</a></h1><p>We mentioned <code>palette.styl</code> in <a href="/vuepress-theme-ajwi/guide/#folder-structure">Folder Structure</a>, it should be under the styles folder. Its purpose is to override the global color setting. With <code>palette.styl</code>, you have the ability to modify not only the colors but also the layout. This is what you can configure:</p><div class="language-stylus"><button title="Copy Code" class="copy"></button><span class="lang">stylus</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">$fonts </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> Open Sans,Inter,Roboto,Oxygen,Fira Sans,Helvetica Neue,sans-serif</span></span>
...
<span class="line"></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">Tip</p><p>Another easy way to modify styles is <a href="https://vuepress.vuejs.org/config/#index-styl" target="_blank" rel="noreferrer">index.styl</a> Additional styles you add have a higher priority than this theme provides.</p></div>`,4),e=[o];function t(c,r,y,D,C,A){return a(),n("div",null,e)}const d=s(p,[["render",t]]);export{F as __pageData,d as default};
